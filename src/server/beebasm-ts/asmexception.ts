...
export class SyntaxError_InvalidSymbolName extends SyntaxError {
  ...
  message =
    'Invalid symbol name; must start with a letter and contain only letters, numbers and underscore.'
}
...
export class SyntaxError_SecondPassProblem extends SyntaxError {
  ...
  message =
    'Fatal error: the second assembler pass has generated different code to the first.'
}
...
export class SyntaxError_6502Bug extends SyntaxError {
  ...
  message =
    'JMP (addr) will not execute as intended due to the 6502 bug (addr = &xxFF).'
}
...
export class SyntaxError_NoAnonSave extends SyntaxError {
  ...
  message =
    'Cannot specify SAVE without a filename if no default output filename has been specified.'
}
export class SyntaxError_MissingAssemblyInstruction extends SyntaxError {
  constructor(line: string, column: number) {
    ...
    Object.setPrototypeOf(
      this,
      SyntaxError_MissingAssemblyInstruction.prototype,
    )
  }
...
export class SyntaxError_InvalidMacroName extends SyntaxError {
  ...
  message =
    'Invalid macro name; must start with a letter and contain only letters, numbers and underscore.'
}
...
export class AssembleError_InconsistentCode extends AssembleError {
  ...
  message =
    'Assembled object code has changed between 1st and 2nd pass. Has a zero-page symbol been forward-declared?'
}
