...
export const beebasmCommands: beebasmCommand[] = [
  ...
  // CLEAR <start>, <end>
  {
    ...
    parameters: [{ label: 'start' }, { label: 'end' }],
  },
  // INCBIN "filename"
  {
    command: 'INCBIN',
  ...
  // PUTBASIC <host filename> [,<beeb filename>]
  {
    ...
    parameters: [{ label: 'host_filename' }, { label: 'beeb_filename' }],
  },
  // MACRO <name> [,<parameter list...>]
  {
    ...
    parameters: [{ label: 'name' }, { label: 'parameter_list' }],
  },
  // ERROR "message"
  {
    command: 'ERROR',
  ...
  // COPYBLOCK <start>,<end>,<dest>
  {
    ...
    parameters: [{ label: 'start' }, { label: 'end' }, { label: 'dest' }],
  },
  // RANDOMIZE <n>
  {
    command: 'RANDOMIZE',
