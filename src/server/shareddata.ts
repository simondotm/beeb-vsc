...
export const opcodeData: Map<number, opcodeinfo> = new Map<number, opcodeinfo> ([
	...
	[128, {mnemonic: 'BRA',addressing: 'r8', bytecode: '80', cycles: '3+p', description: 'Branch always', operation: 'Branch', flags: '--------'}],
	[100, {mnemonic: 'CLR',addressing: 'a8', bytecode: '64', cycles: '3', description: 'Clear memory', operation: '0 -> M', flags: '--------'}],
	[116, {mnemonic: 'CLR',addressing: 'a8,X', bytecode: '74', cycles: '4', description: 'Clear memory', operation: '0 -> M', flags: '--------'}],
	[156, {mnemonic: 'CLR',addressing: 'a16', bytecode: '9C', cycles: '4', description: 'Clear memory', operation: '0 -> M', flags: '--------'}],
	[158, {mnemonic: 'CLR',addressing: 'a16,X', bytecode: '9E', cycles: '5', description: 'Clear memory', operation: '0 -> M', flags: '--------'}],
	[26, {mnemonic: 'INA',addressing: '', bytecode: '1A', cycles: '2', description: 'Increment Memory', operation: 'M + 1 → M', flags: 'N-----Z-'}],
	[218, {mnemonic: 'PHX',addressing: '', bytecode: 'DA', cycles: '3', description: 'Push X register onto stack ', operation: 'X↓', flags: '--------'}],
	[90, {mnemonic: 'PHY',addressing: '', bytecode: '5A', cycles: '3', description: 'Push Y register onto stack ', operation: 'Y↓', flags: '--------'}],
	[250, {mnemonic: 'PLX',addressing: '', bytecode: 'FA', cycles: '4', description: 'Pull X from stack ', operation: 'X↑', flags: 'N-----Z-'}],
	[122, {mnemonic: 'PLY',addressing: '', bytecode: '7A', cycles: '4', description: 'Pull Y from stack ', operation: 'Y↑', flags: 'N-----Z-'}],
	[20, {mnemonic: 'TRB',addressing: 'a8', bytecode: '14', cycles: '5', description: 'Test and reset bits', operation: 'M ∧ ~A → A', flags: '------Z-'}],
	[28, {mnemonic: 'TRB',addressing: 'a16', bytecode: '1C', cycles: '6', description: 'Test and reset bits', operation: 'M ∧ ~A → A', flags: '------Z-'}],
	[4, {mnemonic: 'TSB',addressing: 'a8', bytecode: '04', cycles: '5', description: 'Test and set bits ', operation: 'M ∨ A → A', flags: '------Z-'}],
	[12, {mnemonic: 'TSB',addressing: 'a16', bytecode: '0C', cycles: '6', description: 'Test and set bits ', operation: 'M ∨ A → A', flags: '------Z-'}],
]);