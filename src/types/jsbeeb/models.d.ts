declare module 'jsbeeb/models' {
	export type SWRAM = [
		bank0: boolean, bank1: boolean, bank2: boolean, bank3: boolean,
		bank4: boolean, bank5: boolean, bank6: boolean, bank7: boolean,
		bank8: boolean, bank9: boolean, bankA: boolean, bankB: boolean,
		bankC: boolean, bankD: boolean, bankE: boolean, bankF: boolean
	];
	...
	export class Model {
		...
		isTest: boolean;
		tube: any;
		constructor(name: string, synonyms: string[], os: OsRomTypes[], nmos: boolean, isMaster: boolean, swram: SWRAM, fdc: any, tube: any);
	}
